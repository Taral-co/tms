...
CREATE UNIQUE INDEX idx_email_connectors_tenant_project 
ON email_connectors(tenant_id, project_id) 
WHERE project_id IS NOT NULL;

-- +goose Down
-- Remove the unique constraint
DROP INDEX IF EXISTS idx_email_connectors_tenant_project;
